...
void moveDino(int jump = 0){
    ...
    gotoxy(dinoPos, 16 - dinoY); cout<<"    00B0000     ";
    gotoxy(dinoPos, 17 - dinoY); cout<<"     00000000    ";
    gotoxy(dinoPos, 18 - dinoY); cout<<"      0000000BB   ";
    gotoxy(dinoPos, 19 - dinoY); cout<<"0       000000BBB ";
    gotoxy(dinoPos, 20 - dinoY); cout<<"0       000000BBB ";
    gotoxy(dinoPos, 21 - dinoY); cout<<"           B 000000000";
    gotoxy(dinoPos, 22 - dinoY); cout<<"           B 000000000";
...
void instruction() {
    ...
    cout<<"Instruction";
    cout<<"\n-------------";
    cout<<"\n1. Avoid hurdle by jumping ";
    cout<<"\n2. Press 'Spacebar' to jump ";
    cout<<"\n2. Press 'p' to pause game ";
    cout<<"\n3. Press 'Escape' to exit from game";
